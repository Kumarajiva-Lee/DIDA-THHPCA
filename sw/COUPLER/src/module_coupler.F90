module coupler_mod
  ...
  subroutine init_coupler()
    ...
    !do i = 0, cnn_group - 1
    !  color(atm_stride + i) = CNN_Color
    !  snode_color(atm_stride + i) = 0
    !  atm_gcolor(atm_stride + i) = CNN_Color
    !  snode_atmgcolor(atm_stride + i) = CNN_Color
    !end do
