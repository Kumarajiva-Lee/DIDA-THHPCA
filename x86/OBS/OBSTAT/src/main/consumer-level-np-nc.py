...
#path_nc="/home/users/yuz/job/vv/integrated/ncdata/"
...
for time_in in range(0,1):
    ...
    for proc_in in range(nl_start, nl_end):
        ...
        print("proc_for_norm:",proc_for_norm)
        ...
        print("lat_block_start",lat_block_start)
        print("lat_block_end",lat_block_end)
