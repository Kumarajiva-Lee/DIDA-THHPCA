...
for time_in in range(0,Numtime):
    ...
    for proc_in in range(nl_start, nl_end):
        ...
        #print(bg)
        #print(bg_theta)
        #print(indicator.cal_rmse(an[:,:], tr[:,:]))
        #print(indicator.cal_rmse(an_theta[:,:], tr[:,:]))
        ...
        va.append([rmse_6090N, rmse_3060N, rmse_0030N, rmse_0030S, rmse_3060S, rmse_6090S, rmse_level])
        #print([rmse_6090N, rmse_3060N, rmse_0030N, rmse_0030S, rmse_3060S, rmse_6090S, rmse_level])
        #print(len(va))
        #print(len(runtime))
        ...
        va_theta.append([rmse_theta_6090N, rmse_theta_3060N, rmse_theta_0030N, rmse_theta_0030S, rmse_theta_3060S, rmse_theta_6090S, rmse_theta_level])
        #print([rmse_theta_6090N, rmse_theta_3060N, rmse_theta_0030N, rmse_theta_0030S, rmse_theta_3060S, rmse_theta_6090S, rmse_theta_level])


        #ColorRange = colorrange(variable_in_key)
        #DeltaColorRange = deltacolorrange(variable_in_key)

        print('runtime',runtime)
        print('level_in',level_in)
