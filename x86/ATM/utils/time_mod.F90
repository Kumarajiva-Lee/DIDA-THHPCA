...
contains
  ...
  subroutine time_reset_end_time(time)
  ...
  end subroutine time_reset_end_time

  ! subroutine time_reset_curr_time(time)
  ...
  ! end subroutine time_reset_curr_time
  ...
  subroutine time_add_alert(name, months, days, hours, minutes, seconds, first_alert )
    ...
    logical     , intent(in), optional :: first_alert 
