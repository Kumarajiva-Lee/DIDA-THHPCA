...
contains
  ...
  subroutine halo_init(this, mesh, orient, dtype, host_id, ngb_proc_id, tag, iblk, lon_ibeg, lat_ibeg, &
    ...
    do k = 1, 2
      array_size(:,1,1) = [member_num , mesh%num_full_lon+2*mesh%lon_halo_width,mesh%num_full_lat+mesh%lat_halo_width+mesh%lat_halo_width,num_lev(k)]
      array_size(:,2,1) = [member_num , mesh%num_half_lon+2*mesh%lon_halo_width,mesh%num_full_lat+mesh%lat_halo_width+mesh%lat_halo_width,num_lev(k)]
      array_size(:,1,2) = [member_num , mesh%num_full_lon+2*mesh%lon_halo_width,mesh%num_half_lat+mesh%lat_halo_width+mesh%lat_halo_width,num_lev(k)]
      array_size(:,2,2) = [member_num , mesh%num_half_lon+2*mesh%lon_halo_width,mesh%num_half_lat+mesh%lat_halo_width+mesh%lat_halo_width,num_lev(k)]
      ...
      ! half_lon + half_lat
      mpi_subarray_start(:,2,2) = [0,half_lon_ibeg,full_lat_ibeg,0]
