...
contains
  ...
  subroutine allocate_array_pointer_3d_r4(mesh, array, member, full_lon, half_lon, full_lat, half_lat, full_lev, half_lev)
  ...
  subroutine allocate_array_pointer_3d_r8(mesh, array, member ,full_lon, half_lon, full_lat, half_lat, full_lev, half_lev)
